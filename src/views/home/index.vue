    ...
    <div :class="prefixCls">
        <div class="w">
            <div class="amazing-doge">
                ...
                <div class="btn-group">
                    <div class="btn-item">
                        <router-link tag="a" to="/blindBox">
                            <img src="../../assets/images/home-blind-box.png" alt="">
                            {{$t("common.blind-box")}}
                        </router-link>

                    </div>
                    <div class="btn-item">
                        <a href="https://pancakeswap.finance/swap?outputCurrency=0x0EBc30459551858e81306d583025d12C7d795FA2"
                            target="_blank">
    ...
    export default {
        ...
        data() {
            return {
                ...
                contractTxt: '0x0EBc30459551858e81306d583025d12C7d795FA2'
            }
        },
        computed: {},
        watch: {},
        ...
        methods: {
            copyContractTxt() {
                this.$copyText(this.contractTxt).then(() => {
...
<style lang="scss" scoped>
    ...
    .#{$prefixCls} {
        ...
        background: linear-gradient(180deg, #31BCFF 0%, #00ACFF 100%);
        ...
        .contract {
            ...
            background-repeat: no-repeat;
            background-size: .426666666666667rem .426666666666667rem;
    ...
    @media (max-width: 768px) {
        .#{$prefixCls} {
            ...
            .amazing-doge {
                ...
                background: url('../../assets/images/home-h5-bg.png');
