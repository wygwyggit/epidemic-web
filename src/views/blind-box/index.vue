<template>
    <div :class="prefixCls">
        ...
        <div class="content-box">
            <p>{{$t("blind-box.open-tip-l")}} <span class="num">{{userInfo && userInfo.left_chance}}</span> {{$t("blind-box.open-tip-r")}}</p>
                ...
                <div class="right">
                    ...
                    <div class="val">
                        <span class="val-t">{{userInfo && userInfo.award}}
                            <i v-if="userInfo && userInfo.award">Adoge</i></span>
                ...
                <template v-if="!openIsLoading">
                    <div class="dialog-info">
                        ...
                        <template v-if="openResultType === 2">
                            ...
                            <div class="token-num">
                                <p class="num">{{ token_info.amount }}</p>
        ...
        methods: {
            ...
            vote(act) {
                ...
                return new Promise((resolve, reject) => {
                    this.contract = new ethers.Contract(contractAddress, VOTE_ABI, this.web3Provider.getSigner())
