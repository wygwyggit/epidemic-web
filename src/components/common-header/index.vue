<template>
  <div :class="prefixCls" :style="{ background: myBgColor }">
    ...
    <div
      class="header-slideout"
      :style="{ width: isShowSlider ? '100%' : '0' }"
    >
      <div class="content" v-show="isShowSlider">
        ...
        <nav>
          ...
          >
            ...
            />
            <img
              src="../../assets/images/nav-blind-box.png"
              alt=""
              v-if="tab.name === 'blindBox'"
            />
            <img
              src="../../assets/images/nav-marketplace.png"
              alt=""
              v-if="tab.name === 'marketplace'"
            />
            <img
              src="../../assets/images/nav-my-account-m.png"
              alt=""
              v-if="tab.name === 'account'"
            />
            <img
              src="../../assets/images/net-mining.png"
              alt=""
              v-if="tab.name === 'netMining'"
            />
            {{ $t(`common.${tab.text}`) }}</a
          >
    ...
    <el-dialog
      custom-class="lang-dialog"
      :visible.sync="isShowLangDialog"
      :close-on-click-modal="false"
      width="8.9rem"
    >
      <ul>
...
<script>
import { mainDomain } from "@/config/config.js";
...
.#{$prefixCls} {
  ...
  .header-slideout {
    ...
    .content {
      margin: 1.28rem 0.853333333333333rem 1.333333333333333rem
        0.853333333333333rem;
    }
